            ...
            start: async (controller) => {
                ...
                return this.#mp4Demuxer.run(stream, {
                    async onConfig(config) {
                        ...
                        if (!supported) {
                            console.error('Unsupported codec configuration for VideoDecoder:', config);
    ...
    encode144p(encoderConfig) {
        ...
        const readable = new ReadableStream({
            start: async (controller) => {
                ...
                if (!supported) {
                    const message = 'Unsupported codec configuration for VideoEncoder';
        ...
        return new TransformStream({
            start: (controller) => {
                _decoder = new VideoDecoder({
                    ...
                    error(exception) {
                        console.error('VideoDecoder error', exception);
